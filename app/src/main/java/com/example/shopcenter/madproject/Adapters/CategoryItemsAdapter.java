...
import com.example.shopcenter.madproject.model.CategoryItems;
...
public class CategoryItemsAdapter extends RecyclerView.Adapter<CategoryItemsAdapter.CategoryItemsViewAdapter> {
    ...
    public CategoryItemsViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view;
        view = inflater.inflate(R.layout.admin_category_lists,null);
    ...
    class CategoryItemsViewAdapter<FloatingActionButton> extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        public CategoryItemsViewAdapter(@NonNull View itemView) {
            ...
            ((View) mybutton).setOnClickListener(this);
